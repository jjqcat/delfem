...
OBJS = drawer.o drawer_gl_utility.o quaternion.o uglyfont.o vector3d.o \
	...
	eqn_advection_diffusion.o eqn_diffusion.o eqn_dkt.o eqn_helmholtz.o eqn_linear_solid.o eqn_navier_stokes.o eqn_poisson.o eqn_stokes.o eqn_st_venant.o eqn_hyper.o\
