...
public:     
  ...
  // Get Geometric Type of the Curve  (0:line, 1:arc, 2:polyline)
	virtual CURVE_TYPE GetEdgeCurveType(const unsigned int& id_e) const;
  ...
  CResAddPolygon AddLoop(const std::vector< std::pair<Cad::CURVE_TYPE, std::vector<double> > >& aVal, unsigned int id_l = 0, double scale = 1);
