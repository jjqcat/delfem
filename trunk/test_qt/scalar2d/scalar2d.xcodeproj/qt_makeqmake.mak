...
QMAKE    = /usr/bin/qmake
scalar2d.xcodeproj/project.pbxproj: scalar2d.pro  /usr/local/Qt4.6/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.6/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.6/mkspecs/macx-xcode -macx -o scalar2d.xcodeproj/project.pbxproj scalar2d.pro
