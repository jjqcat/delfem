...
OBJS = drawer.o drawer_gl_utility.o quaternion.o uglyfont.o vector3d.o \
	...
	eqn_advection_diffusion.o eqn_diffusion.o eqn_dkt.o eqn_helmholtz.o eqn_linear_solid.o eqn_navier_stokes.o eqn_poisson.o eqn_stokes.o eqn_st_venant.o eqnsys.o eqnsys_fluid.o eqnsys_scalar.o eqnsys_shell.o eqnsys_solid.o ker_emat_tri.o

VPATH = src/com src/cad src/msh src/femfield\
	src/matvec src/femls src/femeqn src/femeqn src/ls\
	lib\
